...
| PB-301 | Entity dossier scaffold (frontend half of E3.S3.1) | Frontend Claude | `claude-fe/loop-6-pb-301-dossier-scaffold` | Loop #6 — Stage 7 deploy in progress; BE-6 (PR #57) unmerged |
