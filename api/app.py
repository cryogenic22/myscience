...
# BE-10 — Adversary posterior endpoint
try:
    from api.routes import adversary as adversary_route
    _ADVERSARY_ROUTER_OK = True
except Exception as _e:
    logger.error("Failed to import adversary router (BE-10): %s", _e)
    _ADVERSARY_ROUTER_OK = False
...
def create_app() -> FastAPI:
    ...
    if _ADVERSARY_ROUTER_OK:
        all_routers.append(adversary_route.router)
