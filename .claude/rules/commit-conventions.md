...
- `fix(frontend): Fix React error #310 â€” useMemo called inside map loop`
- `fix(frontend): Polish â€” pillar numbers, graph padding, canvas persistence`
- `feat(frontend): Complete Apple-level UI redesign (11 files)`
